...
export const styleVocabulary: StyleVocabulary = {
  scandinavian: {
    budget: {
      prompt:
        PRESERVE +
        "Only replace the movable furniture and decor with new pieces in Scandinavian minimalist style. New furniture: light pine sofa with simple upholstery, round pine coffee table, basic floor lamp, simple open shelving, cotton rug. Colors: white, light pine, soft grey, natural cotton. Materials: pine, cotton, simple textiles. The new furniture must blend naturally with the preserved room, matching the existing lighting, shadows, and perspective. Photorealistic rendering. Clean Nordic look, functional and affordable.",
    ...
    standard: {
      prompt:
        PRESERVE +
        "Only replace the movable furniture and decor with new pieces in Scandinavian style. New furniture: light oak sofa with clean lines, round oak coffee table, minimalist floor lamp, simple shelving unit, woven rug. Colors: warm white, light oak, soft grey, natural linen. Materials: solid oak, natural linen, wool, rattan. The new furniture must blend naturally with the preserved room, matching the existing lighting, shadows, and perspective. Photorealistic rendering. Hygge atmosphere, cozy but uncluttered.",
    ...
    luxury: {
      prompt:
        PRESERVE +
        "Only replace the movable furniture and decor with new pieces in high-end Scandinavian design. New furniture: premium solid walnut sofa with bespoke cushions, Hans Wegner-style lounge chair, designer pendant lamp, custom oak shelving, hand-tufted wool rug. Colors: warm white, smoked oak, warm grey, natural linen, charcoal. Materials: solid walnut, smoked oak, handcrafted wool, ceramic. The new furniture must blend naturally with the preserved room, matching the existing lighting, shadows, and perspective. Photorealistic rendering. Premium Nordic craftsmanship, curated and timeless.",
