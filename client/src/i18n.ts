...
// navigator.language returns tags like "sv-SE", "de-AT", "nb-NO".
// The LanguageDetector uses the first segment automatically (e.g. "sv", "de", "nb").
// We map: da → Danish, sv → Swedish, de → German, nb/no/nn → Norwegian, * → English.
