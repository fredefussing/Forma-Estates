...
const CAMERA_PRESETS: { key: string; name: string; icon: string; animName: string }[] = [
  { key: "SLIDER_LEFT",    name: "Slide Left",      icon: "M19 12H5M12 5l-7 7 7 7",                                                                                                                                                                                                        animName: "cam-slide-left" },
  { key: "SLIDER_RIGHT",   name: "Slide Right",     icon: "M5 12h14M12 5l7 7-7 7",                                                                                                                                                                                                         animName: "cam-slide-right" },
  { key: "PARALLAX_LEFT",  name: "Parallax Left",   icon: "M2.5 12C2.5 6.75 6.75 2.5 12 2.5a9.5 9.5 0 0 1 6.6 2.66M21.5 12c0 5.25-4.25 9.5-9.5 9.5a9.5 9.5 0 0 1-6.6-2.66M2 8l.5 4.5 4-2M22 16l-.5-4.5-4 2",                                                                          animName: "cam-orbit-left" },
  { key: "PARALLAX_RIGHT", name: "Parallax Right",  icon: "M21.5 12C21.5 6.75 17.25 2.5 12 2.5a9.5 9.5 0 0 0-6.6 2.66M2.5 12c0 5.25 4.25 9.5 9.5 9.5a9.5 9.5 0 0 0 6.6-2.66M22 8l-.5 4.5-4-2M2 16l.5-4.5 4 2",                                                                         animName: "cam-orbit-right" },
  { key: "PUSH-IN",        name: "Push-In",         icon: "M5 12h14M12 5l7 7-7 7",                                                                                                                                                                                                         animName: "cam-push-in" },
  { key: "CRANE-DOWN",     name: "Crane Down",      icon: "M12 5v14M5 12l7 7 7-7",                                                                                                                                                                                                         animName: "cam-crane-down" },
  { key: "CRANE-UP",       name: "Crane Up",        icon: "M12 19V5M5 12l7-7 7 7",                                                                                                                                                                                                         animName: "cam-crane-up" },
  { key: "PEDESTAL-DOWN",  name: "Pedestal Down",   icon: "M12 5v14M5 16l7 7 7-7",                                                                                                                                                                                                         animName: "cam-pedestal-down" },
  { key: "PEDESTAL-UP",    name: "Pedestal Up",     icon: "M12 19V5M5 8l7-7 7 7",                                                                                                                                                                                                          animName: "cam-pedestal-up" },
  { key: "PULL-OUT",       name: "Pull-Out",        icon: "M19 12H5M12 5l-7 7 7 7M3 3l18 18",                                                                                                                                                                                              animName: "cam-pull-out" },
                ...
                <>
                  ...
                  <div className="flex gap-3 px-4 py-4 overflow-x-auto" style={{ scrollbarWidth: "none" }}>
                    ...
                    <button
                      ...
                      style={{ width: 200, borderColor: img.presetKey === "DEFAULT" ? "#C8956C" : "#E8E4DE", background: img.presetKey === "DEFAULT" ? "#FDF8F4" : "#F8F6F3" }}
                    ...
                    >
                      ...
                      <span className="text-sm font-semibold" style={{ color: img.presetKey === "DEFAULT" ? "#C8956C" : "#0F1D2F" }}>Auto</span>
                    </button>
                ...
                <>
                  ...
                  <div className="flex gap-3 px-4 py-4 overflow-x-auto" style={{ scrollbarWidth: "none" }}>
                    ...
                    <button
                      ...
                      className="flex-shrink-0 flex flex-col items-center gap-2 p-2.5 rounded-xl border-2 transition-all"
                      style={{ width: 200, borderColor: !img.vfxKey ? "#7C3AED" : "#E8E4DE", background: !img.vfxKey ? "#F5F0FD" : "#F8F6F3" }}
                    ...
                    >
                      <div className="w-full rounded-lg flex items-center justify-center" style={{ aspectRatio: "16/9", background: !img.vfxKey ? "#EDE8FA" : "#F0EDE9" }}>
                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke={!img.vfxKey ? "#7C3AED" : "#9B9690"} strokeWidth="1.5"><path d="M12 2L9.5 9.5H2l6.2 4.5-2.4 7.5L12 17l6.2 4.5-2.4-7.5L22 9.5h-7.5L12 2z"/></svg>
                      </div>
                      <span className="text-sm font-semibold" style={{ color: !img.vfxKey ? "#7C3AED" : "#0F1D2F" }}>Ingen</span>
                    </button>
